...
<!-- /TinyMCE -->
		...
		<?php 	$aksi="modul/mod_about/aksi_about.php";
				$about = mysql_query("SELECT * FROM modul WHERE id_modul='2'");
				$w=mysql_fetch_assoc($about);
				?>
		
		<article class="module width_full">
			<header><h3>Edit About Us</h3></header>
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=about&act=update'>
