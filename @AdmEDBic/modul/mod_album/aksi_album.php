...
if ($module=='album' AND $act=='update'){
  ...
  $judul_web	  = "indonesia-college-yogyakarta";
  $nama_file_unik = $judul_web.$acak.$img_seo.$nama_file; 
	...
	UploadAlbumGaleri($nama_file_unik);
    // Proses watermark image
	//watermark_image("../../../joimg/galeri/$nama_file_unik", "../../../joimg/galeri/$nama_file_unik");
  
    mysql_query("UPDATE album SET  nama			 	= '$_POST[nama]',
									seo					= '$judul_seo',
...
if ($module=='album' AND $act=='insertnew'){
  ...
  $nama_file_unik = $judul_web.$acak.$img_seo.$nama_file; 
	...
	mysql_query("INSERT INTO album(nama,
									seo) 
                            VALUES('$_POST[nama]',
                                   '$judul_seo')");
	}
