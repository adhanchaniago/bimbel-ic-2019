...
<!-- /TinyMCE -->
		...
		<?php 	$aksi="modul/mod_carapendaftaran/aksi_carapendaftaran.php";
				$about = mysql_query("SELECT * FROM modul WHERE id_modul='17'");
				$w=mysql_fetch_array($about);
				?>
		
		<article class="module width_full">
			<header><h3>Edit Cara Pendaftaran</h3></header>
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=carapendaftaran&act=update'>
