...
<!-- /TinyMCE -->
		...
		<?php 	$aksi="modul/mod_jadwal/aksi_jadwal.php";
				$about = mysql_query("SELECT * FROM modul WHERE id_modul='15'");
				$w=mysql_fetch_array($about);
				?>
		
		<article class="module width_full">
			<header><h3>Edit Jadwal</h3></header>
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=jadwal&act=update'>
