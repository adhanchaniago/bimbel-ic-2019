...
<!-- /TinyMCE -->
		...
		<?php 	$aksi="modul/mod_keunggulan/aksi_keunggulan.php";
				$about = mysql_query("SELECT * FROM modul WHERE id_modul='13'");
				$w=mysql_fetch_array($about);
				?>
		
		<article class="module width_full">
			<header><h3>Edit Keunggulan</h3></header>
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=keunggulan&act=update'>
