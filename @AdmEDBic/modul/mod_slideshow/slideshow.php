			 ...
			 <form method='POST' enctype='multipart/form-data' action='modul/mod_slideshow/aksi_slideshow.php?module=slideshow&act=insertnew'>
				<div class="module_content">
						...
						<fieldset style="float:left; width:30%; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->
							...
							<br /> &nbsp;&nbsp;&nbsp;&nbsp;*) Image size 1080 x 450px.
						</fieldset>
						<fieldset style="float:left; width:100%; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->
							<label>Deskripsi Singkat</label><br /><br />
							<textarea style="width: 87%; margin-left:10px; margin-right:-20px;" name="deskripsi" rows="5" maxlength="250" required></textarea>
							<br /><br /><br /><br /><br /><br /> &nbsp;&nbsp;&nbsp;&nbsp; *) Max. 250 Characters.
						</fieldset>
		...
		<article class="module width_quarter" style="width: 50%;">
			 ...
			 <form method='POST' enctype='multipart/form-data' action='modul/mod_slideshow/aksi_slideshow.php?module=slideshow&act=update'>
				...
				<div class="module_content">
						...
						<fieldset style="float:left; width:100%; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->
							<label>Deskripsi Singkat</label><br /><br />
							<textarea style="width: 87%; margin-left:10px; margin-right:-20px;" name="deskripsi" rows="5" maxlength="250" required><?php echo $g[deskripsi];?></textarea>
							<br /><br /><br /><br /><br /><br /> &nbsp;&nbsp;&nbsp;&nbsp; *) Max. 250 Characters.
						</fieldset>
						<style>fieldset input[type=text]{width:87%} fieldset textarea {width:85%}</style>
						<div class="clear"></div>
