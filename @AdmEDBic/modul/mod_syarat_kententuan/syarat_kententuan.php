...
<!-- /TinyMCE -->
		...
		<?php 	$aksi="modul/mod_syarat_kententuan/aksi_syarat_kententuan.php";
				$howtoorder = mysql_query("SELECT * FROM modul WHERE id_modul='7'");
				$w=mysql_fetch_array($howtoorder);
				?>
		
		<article class="module width_full">
			<header><h3>Edit Syarat dan Ketentuan</h3></header>
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=syarat_kententuan&act=update'>
