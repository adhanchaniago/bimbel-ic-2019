...
<!-- /TinyMCE -->
		...
		<?php 	$aksi="modul/mod_visimisi/aksi_visimisi.php";
				$about = mysql_query("SELECT * FROM modul WHERE id_modul='14'");
				$w=mysql_fetch_array($about);
				?>
		
		<article class="module width_full">
			<header><h3>Edit Visi dan Misi</h3></header>
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=visimisi&act=update'>
